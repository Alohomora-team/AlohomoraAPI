...
class UserModelTest(TestCase):
    ...
    def setUpTestData(cls):
        User.objects.create(complete_name='Big', email='Bob', password='12345', phone='12345', apartment='42', block='13')
...
class VisitorModelTest(TestCase):
    ...
    def setUpTestData(cls):
        User.objects.create(complete_name='Big', email='Bob', password='12345', phone='12345', apartment='42', block='13')
        Visitor.objects.create(owner = User.objects.get(id=1), complete_name='Big', email='Bob', phone='12345')
