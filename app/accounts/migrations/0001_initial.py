# Generated by Django 2.2.5 on 2019-11-03 14:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pending', models.BooleanField(default=True, verbose_name='entry status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entries', models.ManyToManyField(through='accounts.EntryVisitor', to='condos.Apartment')),
            ],
        ),
        migrations.AddField(
            model_name='entryvisitor',
            name='visitor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.Visitor'),
        ),
        migrations.CreateModel(
            name='Entry',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entries', models.ManyToManyField(related_name='entries', through='accounts.Entry', to='condos.Apartment')),
            ],
        ),
        migrations.AddField(
            model_name='entry',
